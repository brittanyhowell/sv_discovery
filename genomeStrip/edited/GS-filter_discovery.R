...
sample.name.ext <- paste(file.DIR,"226_discovery_genotypes.txt" , sep="/")
sample.name <- "disc"
...
# Coordinate tables
centromere.coord <- "/Users/bh10/Documents/Rotations/Rotation3/data/hg38/centromere_GRCh38_combined.txt"  # Table containing coordinates of centromeres
gaps.coord <- "/Users/bh10/Documents/Rotations/Rotation3/data/hg38/gaps_GRCh38.txt"                       # Table containing coordinates of gaps
more.gaps.coord <- "/Users/bh10/Documents/Rotations/Rotation3/data/hg38/gaps_human.txt"                   # Table containing coordinates of more gaps
...
summary(edels$`[5]GSELENGTH`)

indsize <- edels$`[5]GSELENGTH` > 50 & edels$`[5]GSELENGTH` < 1000000
...
part.filt.dels <- edels[which(indsize),] # & indrp & indrd 
