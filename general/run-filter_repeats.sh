...
# bsub  -o /nfs/team151/bh10/scripts/bh10_general/output/repeatFilter/repFilt-%J-%I.out -e /nfs/team151/bh10/scripts/bh10_general/output/repeatFilter/repFilt-%J-%I.err  -R"select[mem>3000] rusage[mem=3000]" -M3000  "/nfs/team151/bh10/scripts/bh10_general/run-filter_repeats-CNV.sh" 
...
# delIn="BD_filtered_DEL_disc.txt"
