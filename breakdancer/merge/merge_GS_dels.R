...
## echo 'R CMD BATCH --vanilla --slave --args --ID=${LSB_JOBINDEX} ~/projects/HGDP/scripts/merge_GS_dels.R' | bsub -J 'chr[1-24]' -R "select[mem>=1000] rusage[mem=1000]" -M1000 -o /lustre/scratch114/projects/hgdp_wgs/sv/log_files/merge_GS_dels/chr%I.out 
...
dels <- read.table("/lustre/scratch114/projects/hgdp_wgs/sv/other_callsets/gs_dels_GRCh38_filtered.bed", stringsAsFactors=F)           ## 11,489
...
fclust <- fclust[ord,]
## save
fn <- paste("/lustre/scratch114/projects/hgdp_wgs/sv/other_callsets/gs_merged_regions/chr",i,".txt", sep="")
